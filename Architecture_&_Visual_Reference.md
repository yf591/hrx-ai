...
```
11. ユーザーインターフェース主要画面フロー - 画面遷移
ここに「12. 給与・報酬分析ワークフロー図」として追加
12. 離職リスク予測シーケンス図 - 特定機能の詳細（12から13に変更する）
13. AI採用プロセスフローチャート - 特定機能の詳細（13から14に変更する）
ここに「14. 従業員エンゲージメント分析フロー図」として追加
14. テスト戦略マップ - 品質保証計画（14から15に変更する）
(以下同様に番号を修正)
```
